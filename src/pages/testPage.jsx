    ...
    return(
        <div className="w-full h-screen flex justify-center items-center flex-col">
            ...
            <div className="w-[450px] h-[250px] shadow flex flex-col justify-center items-center">
                {/*id user password or failed span tag */}
                <span className="text-[40px] font-bold text-center w-[100px] h-[40px] mx-[10px] flex justify-center items-center">
                    {status}
                </span>
                <div>
                    <button className="bg-blue-500 text-white font-bold text-center w-[100px] h-[40px] text-[20px] cursor-pointer m-[20px]"
                    onClick={()=>{
                        setStatus("passed")
                    }}>
                        passed
                    </button>
                    <button className="bg-red-500 text-white font-bold text-center w-[100px] h-[40px] text-[20px] cursor-pointer m-[20px]"
                    onClick={()=>{
                        setStatus("failed")
                    }}>
                        failed
