    ...
    */
    ...
    return(
        <div className="w-full h-full flex flex-col justify-center item-center">
            ...
            <input type="file" placeholder="Images (comma separated URLs)" multiple className="input input-bordered w-full max-w-xs" onChange={(e)=>{setImages(e.target.files.split(","))}}/>
            ...
            <div className="flex justify-center items-center mt-4">
                ...
                <button className="bg-green-400 text-white font-bold py-2 px-4 rounded">Add Product</button>
            </div>
        </div>
    )
}